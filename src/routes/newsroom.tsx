...
export const Route = createFileRoute("/newsroom")({
  head: () => ({ meta: [{ title: "Newsroom — MoneyTree Realty" }, { name: "description", content: "Latest news, press releases and media coverage from MoneyTree Realty." }] }),
  component: () => (
    <InfoPage eyebrow="Press" title="Newsroom" heroImg={hero}
      intro="Press releases, announcements and stories from across MoneyTree Realty."
      sections={[
