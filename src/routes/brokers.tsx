...
export const Route = createFileRoute("/brokers")({
  head: () => ({ meta: [{ title: "Brokers — Emaar" }, { name: "description", content: "Become a registered Emaar broker — programme details and registration." }] }),
  component: () => (
    <InfoPage eyebrow="Partners" title="Brokers" heroImg={hero}
      intro="Partner with Dubai's leading developer and unlock unmatched commission structures."
      sections={[
