...
export const Route = createFileRoute("/properties/villas")({
  head: () => ({ meta: [{ title: "Villas — MoneyTree Realty" }, { name: "description", content: "Luxury villas in Noida's most prestigious gated communities." }] }),
  component: () => (
    <InfoPage eyebrow="Family Living" title="Villas" heroImg={hero}
      ...
      sections={[
        { heading: "Premier Communities", body: "Villas across Arabian Ranches, Noida Hills Estate, MoneyTree Realty South and The Valley." },
