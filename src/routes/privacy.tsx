...
export const Route = createFileRoute("/privacy")({
  head: () => ({ meta: [{ title: "Privacy Policy — Emaar" }, { name: "description", content: "How Emaar collects, uses and protects your personal data." }] }),
  component: () => (
    <InfoPage eyebrow="Legal" title="Privacy Policy" heroImg={hero}
      ...
      sections={[
        ...
        { heading: "Your Rights", body: "You have the right to access, correct, delete or restrict processing of your personal data. Contact privacy@emaar.ae to exercise these rights." },
      ]} />
  ),
});
