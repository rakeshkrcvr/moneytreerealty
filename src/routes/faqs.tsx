...
export const Route = createFileRoute("/faqs")({
  head: () => ({ meta: [{ title: "FAQs — Golden Door Realty" }, { name: "description", content: "Answers to the most common buyer, owner and investor questions." }] }),
  component: () => (
    <InfoPage eyebrow="Help" title="Frequently Asked Questions" heroImg={hero}
      ...
      sections={[
        ...
        { heading: "Can non-residents buy?", body: "Yes — Golden Door Realty properties are located in Dubai freehold areas, allowing 100% foreign ownership." },
        { heading: "How do I get my title deed?", body: "Title deeds are issued by the Dubai Land Department after handover and full payment. Our team handles registration on your behalf." },
      ]} />
  ),
});
