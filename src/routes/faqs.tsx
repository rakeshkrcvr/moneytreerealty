...
export const Route = createFileRoute("/faqs")({
  head: () => ({ meta: [{ title: "FAQs — Emaar" }, { name: "description", content: "Answers to the most common buyer, owner and investor questions." }] }),
  component: () => (
    <InfoPage eyebrow="Help" title="Frequently Asked Questions" heroImg={hero}
      ...
      sections={[
        ...
        { heading: "Can non-residents buy?", body: "Yes — Emaar properties are located in Dubai freehold areas, allowing 100% foreign ownership." },
