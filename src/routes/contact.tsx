...
export const Route = createFileRoute("/contact")({
  head: () => ({ meta: [{ title: "Contact Us — Emaar" }, { name: "description", content: "Get in touch with Emaar — sales, customer care and corporate enquiries." }] }),
  component: () => (
