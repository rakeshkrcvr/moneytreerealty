...
export const Route = createFileRoute("/properties/apartments")({
  head: () => ({ meta: [{ title: "Apartments — Emaar Properties" }, { name: "description", content: "Premium apartments across Dubai's most sought-after addresses." }] }),
  component: () => (
    <InfoPage eyebrow="Residences" title="Apartments" heroImg={hero}
      ...
      sections={[
        { heading: "Iconic Addresses", body: "From Downtown Dubai to Emaar Beachfront, our apartments offer breathtaking views and best-in-class amenities." },
