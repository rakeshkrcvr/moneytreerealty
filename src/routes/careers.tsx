...
export const Route = createFileRoute("/careers")({
  head: () => ({ meta: [{ title: "Careers — MoneyTree Realty" }, { name: "description", content: "Join MoneyTree Realty and help shape the future of premium living." }] }),
  component: () => (
    <InfoPage eyebrow="Join Us" title="Careers" heroImg={hero}
      ...
      sections={[
        { heading: "Why MoneyTree Realty", body: "We attract and retain the best talent by offering meaningful work, world-class projects, and an environment where creativity and entrepreneurship thrive." },
