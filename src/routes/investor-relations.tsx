...
export const Route = createFileRoute("/investor-relations")({
  head: () => ({ meta: [{ title: "Investor Relations — MoneyTree Realty" }, { name: "description", content: "Financial reports, disclosures and shareholder information." }] }),
  component: () => (
    <InfoPage eyebrow="Shareholders" title="Investor Relations" heroImg={hero}
      ...
      sections={[
        { heading: "Financial Highlights", body: "MoneyTree Realty continues to deliver record revenue and profitability driven by strong real estate sales and recurring income." },
