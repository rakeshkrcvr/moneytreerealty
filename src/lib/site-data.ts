...
export const launches: LaunchItem[] = [
  { slug: "aurora-heights", title: "Aurora Heights", location: "Downtown Dubai", price: "From ₹ 2.4M", type: "Apartments", img: l1,
    description: "Sky-high living in the heart of Downtown with panoramic Burj Khalifa views.",
    bedrooms: "1, 2 & 3 BR", handover: "Q4 2027" },
  { slug: "park-greens", title: "Park Greens", location: "Dubai Hills Estate", price: "From ₹ 3.9M", type: "Townhouses", img: l2,
  ...
  { slug: "marina-vista", title: "Marina Vista", location: "Dubai Marina", price: "From ₹ 1.9M", type: "Apartments", img: marina,
    description: "Sleek waterfront residences overlooking the Marina and Palm Jumeirah.",
    bedrooms: "Studio – 3 BR", handover: "Q3 2026" },
  { slug: "creek-palace", title: "Creek Palace", location: "Dubai Creek Harbour", price: "From ₹ 2.8M", type: "Apartments", img: creek,
    description: "Elevated creek-side residences with dual skyline and water vistas.",
    bedrooms: "1, 2 & 3 BR", handover: "Q4 2026" },
  { slug: "hills-grove", title: "Hills Grove", location: "Dubai Hills Estate", price: "From ₹ 4.5M", type: "Villas", img: hills,
