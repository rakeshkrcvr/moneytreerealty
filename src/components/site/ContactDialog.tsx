        ...
        <DialogContent className="max-w-3xl p-0 overflow-hidden gap-0">
          <div className="grid md:grid-cols-5">
            <div className="hidden md:flex md:col-span-2 flex-col justify-between bg-ink text-white p-8">
              <div>
                <p className="text-[10px] tracking-[0.4em] uppercase text-gold mb-3">Emaar</p>
              ...
              <div className="space-y-3 text-sm text-white/80 mt-8">
                ...
                <p className="flex items-center gap-3"><Mail className="w-4 h-4 text-gold" /> sales@emaar.ae</p>
            ...
            <div className="md:col-span-3 p-8">
              ...
              <form onSubmit={onSubmit} className="space-y-3" noValidate>
                ...
                <p className="text-[10px] text-muted-foreground leading-relaxed">
                  By submitting this form you agree to Emaar's Privacy Policy and consent to be contacted.
                </p>
              </form>
            </div>
          </div>
